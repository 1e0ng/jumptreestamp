    ...
    draw: function (ctx) {
        ...
        for(var layerIdx = 0; layerIdx < gMap.currMapData.layers.length; layerIdx++) {
            ...
            for(var tileIDX = 0; tileIDX < dat.length; tileIDX++) {
                ...
                //
                // YOUR CODE HERE
                var dx = tileIDX % this.numXTiles * this.tileSize.x;
                var dy = Math.floor(tileIDX / this.numXTiles) * this.tileSize.y;
                
                ctx.drawImage(tPKT.img, tPKT.px, tPKT.py, this.tileSize.x, this.tileSize.y, dx, dy, this.tileSize.x, this.tileSize.y);
